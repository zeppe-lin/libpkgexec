...
grep -F "version: '2.2.0'" "$root/meson.build" >/dev/null || fail 'project version is not 2.2.0'
...
grep -F '## libpkgexec 2.2.0' "$root/HISTORY.md" >/dev/null || fail '2.2.0 history entry is absent'
